...
public class ProcessMappingRegistry {
    ...
    static {
        ...
        put(StepMappingEnum.DIRTY_CHECKING_BEFORE_AA,    MoDirtyCheck.class,                 IMoDirtyCheckService.class);
        put(StepMappingEnum.DIRTY_CHECKING_AFTER_AA,     MoDirtyCheck.class,                 IMoDirtyCheckService.class);
