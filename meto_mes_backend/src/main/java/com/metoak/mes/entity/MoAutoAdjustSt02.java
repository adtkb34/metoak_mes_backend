 ...
 */
@TableName("mo_auto_adjust_st02")
@ApiModel(value = "MoAutoAdjustSt02对象", description = "")
public class MoAutoAdjustSt02 implements Serializable {
