 ...
 */
@TableName("view_stereo_precheck_oqc")
@ApiModel(value = "ViewStereoPrecheckOqc对象", description = "VIEW")
public class ViewStereoPrecheckOqc implements Serializable {
