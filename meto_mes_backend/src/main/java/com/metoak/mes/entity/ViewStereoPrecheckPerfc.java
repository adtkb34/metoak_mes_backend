 ...
 */
@TableName("view_stereo_precheck_perfc")
@ApiModel(value = "ViewStereoPrecheckPerfc对象", description = "VIEW")
public class ViewStereoPrecheckPerfc implements Serializable {
    ...
    public String toString() {
        return "ViewStereoPrecheckPerfc{" +
            "id = " + id +
            ", datetime = " + datetime +
            ", sn = " + sn +
            ", errorCode = " + errorCode +
