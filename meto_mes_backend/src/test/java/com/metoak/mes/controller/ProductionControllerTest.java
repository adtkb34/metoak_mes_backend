...
//        assertEquals(8, moAutoAdjustInfo.getStationNum());
    ...
    @Test
    void production_316_QC_1() throws Exception {
        String beamSn = String.valueOf(System.currentTimeMillis());
        ProductionRecordDto productionRecordDto = new ProductionRecordDto();
        productionRecordDto.setProductSn(beamSn);
        productionRecordDto.setStartTime(String.valueOf(System.currentTimeMillis()));
        productionRecordDto.setEndTime(String.valueOf(System.currentTimeMillis()));
        productionRecordDto.setStepTypeNo("034");
        productionRecordDto.setOperator("szdev");
        productionRecordDto.setError("SUCCESS");
        productionRecordDto.setErrorNo("0");
        productionRecordDto.setDeviceNo("0");

        List<AttrKeyValDto> attrKeyValDtoLefts = new ArrayList<>();

        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("000").position("0").key("startTime").val("1763968600352").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("001").position("0").key("endTime").val("1763968630352").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("002").position("0").key("errorCode").val("0x12").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("003").position("0").key("isOqc").val("false").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("004").position("0").key("productType").val("1").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("005").position("0").key("isSigned").val("false").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("006").position("0").key("versionMcu").val("szdev").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("007").position("0").key("imuTx").val("0.0296908").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("008").position("0").key("imuTy").val("0.000400807").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("009").position("0").key("imuTz").val("-0.0206433").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("010").position("0").key("imuQangleDeg").val("179.961").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("011").position("0").key("distance1Error").val("1").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("012").position("0").key("distance1Density").val("2").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("013").position("0").key("distance2Error").val("3").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("014").position("0").key("distance2Density").val("4").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("015").position("0").key("materialRoot").val("5").build());
...
//        assertEquals(8, moAutoAdjustInfo.getStationNum());
    ...
    @Test
    void production_316_QC_2() throws Exception {
        String beamSn = String.valueOf(System.currentTimeMillis());
        ProductionRecordDto productionRecordDto = new ProductionRecordDto();
        productionRecordDto.setProductSn(beamSn);
        productionRecordDto.setStartTime(String.valueOf(System.currentTimeMillis()));
        ...
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("001").position("0").key("endTime").val("1763968630352").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("002").position("0").key("errorCode").val("0x12").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("003").position("0").key("isOqc").val("true").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("004").position("0").key("productType").val("1").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("005").position("0").key("isSigned").val("true").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("006").position("0").key("versionMcu").val("szdev").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("007").position("0").key("imuTx").val("0.0296908").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("008").position("0").key("imuTy").val("0.000400807").build());
        attrKeyValDtoLefts.add(new AttrKeyValDto().builder().no("009").position("0").key("imuTz").val("-0.0206433").build());
