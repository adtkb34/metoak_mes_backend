    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI().info(
                new Info()
                        .title("MES管理系统API")
                        .version("1.0")
                        .description("MES管理系统API"));
    }

    @Bean
    public GroupedOpenApi moCalibrationAPI() {

        return GroupedOpenApi.builder().group("信息管理").
                pathsToMatch(
                        "/api/mes/v1/user/**",
                        "/api/mes/v1/production/**",
                        "/api/mes/v1/workOrders/**",
                        "/api/mes/v1/spc/**",
                        "/api/mes/v1/basic-information/**",
                        "/api/v1/moAutoAdjustInfo/**"
                ).
                build();
    }
//
