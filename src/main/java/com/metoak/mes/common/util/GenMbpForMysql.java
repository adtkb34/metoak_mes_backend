...
//                            .fileOverride()   // 覆盖已生成文件
                            ...
                            .outputDir("D:\\mosrc\\meto_mes_backend\\src\\main\\java\\");    // 指定输出目录
                })
...
//                            .moduleName("model")      // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\mosrc\\meto_mes_backend\\src\\main\\resources\\mapper")); // 设置mapper Xml生成路径
                })
